...
float g_glass_r = 50.0f;
float g_glass_g = 0.0f;
float g_glass_b = 50.0f;
...
static void render_scene()
{
	...
	glUniform1iv(g_materialTexturedIndex, 1, &g_material[0].textured);
	...
	glUniform1iv(g_materialTexturedIndex, 1, &g_material[1].blended);
	...
	glUniform1iv(g_materialTexturedIndex, 1, &g_material[5].blended);
	...
	glUniform1iv(g_materialTexturedIndex, 1, &g_material[3].blended);
...
int main(void)
{
	...
	TwAddVarRW(TweakBar, "R", TW_TYPE_FLOAT, &g_glass_r, " group='Glass Pane' min=0.0 max=255.0 step=0.01 ");
	TwAddVarRW(TweakBar, "G", TW_TYPE_FLOAT, &g_glass_g, " group='Glass Pane' min=0.0 max=255.0 step=0.01 ");
	TwAddVarRW(TweakBar, "B", TW_TYPE_FLOAT, &g_glass_b, " group='Glass Pane' min=0.0 max=255.0 step=0.01 ");
